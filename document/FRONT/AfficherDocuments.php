                    ...
                    <div class="col-lg-12">
                        <div class="meeting-single-item">
                            ...
                            try {
                                ...
                                $New=intval($_GET['id']);
                                $categorie = "SELECT * FROM document where idCategorie=$New";
                                $result= $pdo->query($categorie);

                                foreach ($result as $x)
                                {
                                    echo "
                <div class='down-content'>
                  <a href='meeting-details.html'><h4>".$x[0]."</h4></a>
                  <br>
                            <a href='file_name.pdf' download='newfilename'>Download the pdf</a>
                </div>
                ";
                    ...
                    <div class="col-lg-12">
                        <div class="main-button-red">
                            <a href="AfficherCategories.php">Retour vers toutes les catgeories</a>
                        </div>
                    </div>
                </div>
            </div>
