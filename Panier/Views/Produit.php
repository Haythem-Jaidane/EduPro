<?php
    ...
    $prix=100;
    $Link="assets/images/single-meeting.jpg";
    $nom="Online Teaching and Learning Tools";
    // create adherent
    $Item = null;
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li>
                            <a href="panier.php">
                              <i class="fa fa-shopping-cart" style="font-size:24px;color:white;"><?php echo $ItemC->length();  ?></i>
                            </a>
                          </li>
                      </ul>        
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  <div class="price">
                    <?php echo "<span>$prix dt</span>"; ?>
                  </div>
                  <div class="date">
                    <h6>Nov <span>12</span></h6>
                  </div>
                  <?php echo '<a href="meeting-details.html"><img src='.$Link.' alt=""></a>' ?>
                </div>
                    ...
                    <div class="col-lg-4">
                      <div class="book now">
                        <form action="" method="POST">
                          ...
                          <input type="submit" value="Ajouter Au panier" id="Quantite">
                        </form>
                      </div>
                    </div>
                    <div class="col-lg-12">
